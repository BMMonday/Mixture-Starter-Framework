...
;(function($, window, document, undefined){
    ...
    NivoLightbox.prototype = {
        ...
        processContent: function(content, link){
        	...
        	content.html('').addClass('nivo-lightbox-loading').append('<i class="im spin-icon spin-iconner"></i>');
        ...
        constructLightbox: function(){
        	...
        	var nav = $('<a href="#" class="nivo-lightbox-nav nivo-lightbox-prev">Previous<i class="im icn-arrow-left"></i></a><a href="#" class="nivo-lightbox-nav nivo-lightbox-next">Next<i class="im icn-arrow-right"></i></a>');
        	var close = $('<a href="#" class="nivo-lightbox-close" title="Close">Close<i class="im icn-close"></i></a>');
